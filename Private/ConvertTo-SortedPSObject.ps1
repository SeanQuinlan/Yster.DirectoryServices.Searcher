function ConvertTo-SortedPSObject {
    ...
    .NOTES
        ...
        Faster than using Add-Member, and faster than using the $Object.PSObject.Properties.Add($PSNoteProperty) method I use in other places in this module.
    #>
    ...
    $Input_Object_Properties | Sort-Object -Property 'Name' | ForEach-Object {
        $Input_Object_Sorted[$_.Name.ToLower()] = $_.Value
    }
